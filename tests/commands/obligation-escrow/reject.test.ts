...
import { rejectHandler, promptForInputs } from '../../../src/commands/obligation-escrow/reject';
...
vi.mock('../../../src/commands/obligation-escrow/runTx', () => ({
  runObligationEscrowTx: vi.fn().mockResolvedValue({ hash: '0xreject' }),
}));
...
describe('obligation-escrow/reject', () => {
  ...
  it('rejectHandler runs SDK via runObligationEscrowTx', async () => {
