...
import { validatePreviousHolder } from '../../../src/commands/helpers';
...
vi.mock('../../../src/commands/helpers', () => ({
  connectToTitleEscrow: vi.fn().mockResolvedValue({
    ...
    rejectTransferHolder: vi.fn().mockResolvedValue({
      hash: 'hash',
      wait: () => Promise.resolve({ transactionHash: 'transactionHash' }),
    }),
    estimateGas: {
      rejectTransferHolder: vi.fn().mockResolvedValue(100000n),
    },
  }),
